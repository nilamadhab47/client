...
export default function PutEvent() {
  ...
  const fetchData = async () => {
    const response = await fetch(`https://candleriggs.herokuapp.com/api/getEvents/${_id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios({
        method: "put",
        url: `https://candleriggs.herokuapp.com/api/updateEvents/${_id}`,
        data: formData,
            ...
            <form  onSubmit={handleSubmit}>
              ...
              <div className="dragingImageBanner">
                ...
                <p>Supports: JPG , PNG , SVG , GIF , JPEG (Max Size : 2MB)</p>
                      ...
                      <label htmlFor="uploadMainImage" ><img src={dragCloud} alt="" /></label>
<input type="file" id="uploadMainImage" onChange={handleChange} accept="image/*" style={{display:"none"}}  ></input>
                ...
                <p>Supports: JPG , PNG , SVG , GIF , JPEG (Max Size : 2MB)</p></div>
                      ...
                      <div className="dragingpara2">
                        <label htmlFor="uploadMobileImage" ><img src={dragCloud} alt="" /></label>
<input type="file" id="uploadMobileImage"  onChange={handleChange} accept="image/*" name="" style={{display:"none"}} ></input>
                        <p>Drag and drop or browse to choose a file</p>
                      </div>
                          ...
                          <div className="row row-cols-4">
                            <div className="col selectOption">
                              {/* <input
                                ...
                                onChange={handleChange}
                              /> */}
                              <select required  value={data.showStartHour}
                                onChange={handleChange} style={{"-webkit-appearance": "none",marginTop:"0.7rem"}} name="cars" id="showStartHour">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
    ...
    <option >12</option>
                            ...
                            <div className="secondInput selectOption col">
                              {/* <input
                                ...
                                onChange={handleChange}
                              /> */}
                               <select required   value={data.showStartMinute}
                                onChange={handleChange}  style={{"-webkit-appearance": "none",marginLeft:"-1.3rem",marginTop:"0.7rem"}} name="cars" id="showStartMinute">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required  value={data.showStartZone}
                                  onChange={handleChange}  style={{"-webkit-appearance": "none"}}  name="cars" id="showStartZone">
    <option >Zone</option>
    <option >AM</option>
    <option >PM</option>
  </select>
  ...
  <select required className="selectClass"   value={data.doorOpenHour}
                                onChange={handleChange} style={{"-webkit-appearance": "none"}} typeof="number" name="cars" id="doorOpenHour">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required className="selectClass selectClass2"    value={data.doorOpenMinute}
                                onChange={handleChange}  style={{"-webkit-appearance": "none"}} name="cars" id="doorOpenMinute">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required value={data.doorOpeningZone}
                                  onChange={handleChange}  style={{"-webkit-appearance": "none"}}  name="cars" id="doorOpeningZone">
    <option >Zone</option>
    <option >AM</option>
    <option >PM</option>
  </select>
                      ...
                      <div className="timeHeading datenewStyle timeheadingDate col">
                        <p> Date</p>{" "}
                        <input required type="date" name="date" id="date" style={{marginTop:"1rem"}}  value={data.date}
                    onChange={handleChange} />
                      </div>
  ...
  <select required className="selectClass"  value={data.eventStartHour}
                                onChange={handleChange} style={{"-webkit-appearance": "none"}} typeof="number" name="cars" id="eventStartHour">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required className="selectClass selectClass2"   value={data.eventStartMinute}
                                onChange={handleChange}  style={{"-webkit-appearance": "none"}} name="cars" id="eventStartMinute">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required   value={data.eventStartZone}
                                  onChange={handleChange}  style={{"-webkit-appearance": "none"}}  name="cars" id="eventStartZone">
    <option >Zone</option>
    <option >AM</option>
    <option >PM</option>
  </select>
  ...
  <select required className="selectClass"  value={data.eventEndHour}
                                onChange={handleChange} style={{"-webkit-appearance": "none"}} typeof="number" name="cars" id="eventEndHour">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required className="selectClass selectClass2"   value={data.eventEndMinute}
                                onChange={handleChange}style={{"-webkit-appearance": "none"}} name="cars" id="eventEndMinute">
    <option ></option>
    <option >1</option>
    <option >2</option>
    <option >3</option>
  ...
  <select required    value={data.eventEndZone}
                                  onChange={handleChange}  style={{"-webkit-appearance": "none"}}  name="cars" id="eventEndZone">
    <option >Zone</option>
    <option >AM</option>
    <option >PM</option>
  </select>
